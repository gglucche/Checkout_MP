...
addEvent(document.querySelector('input[data-checkout="cardNumber"]'), 'change', guessingPaymentMethod);
cardsHandler();
function mostraBandeira(este) {
        document.getElementById("visa").style.opacity = "0.3";
        document.getElementById("master").style.opacity = "0.3";
        document.getElementById("elo").style.opacity = "0.3";
        document.getElementById("diners").style.opacity = "0.3";
        document.getElementById("hipercard").style.opacity = "0.3";
        document.getElementById("amex").style.opacity = "0.3";
        document.getElementById("melicard").style.opacity = "0.3";
        document.getElementById(este).style.opacity = "1";
		document.getElementById("bandeira").value = este;
    }